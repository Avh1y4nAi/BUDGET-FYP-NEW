<div className="d-flex flex-column min-vh-100">
  ...
  <header className="hero-section text-center py-5" style={{ background: "linear-gradient(135deg, #f0fdf4 0%, #e0f2fe 100%)" }}>
    ...
    <div className="container my-5">
      <div className="row align-items-center gx-5">
        ...
        <div className="col-lg-6 mb-5 mb-lg-0">
          <div className="bg-light rounded-4 p-5 text-center shadow-sm" style={{minHeight: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            <div>
        ...
        <div className="col-lg-6">
          <div className="ps-lg-4">
            ...
            <a href="/signup" className="btn btn-accent px-4 py-2 rounded-pill">
              Join Our Mission
            </a>
          </div>
        </div>
    ...
    <div className="container my-5 text-center">
      <div className="row justify-content-center">
        <div className="col-lg-8">
          ...
          <a href="/contact" className="btn btn-outline-dark px-5 py-3 rounded-pill">
            Get in Touch
          </a>
        </div>
      </div>
